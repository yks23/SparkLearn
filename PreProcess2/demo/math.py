...
class get_result(object):
    def __init__(self,host):
        ...
        self.Secret = "Y2ExMGViM2RjMjdjNmZhNjkyNjZkZDhi"
        # 接口APIKey（到控制台公式识别服务页面获取）
        self.APIKey= "c87bad1f164b70337becc4d833246d17"
        ...
        #设置测试图片文件
        self.AudioPath="/mnt/d/code/python/TextRecognize/source/formula_text.png"
        self.BusinessArgs={
